            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}" style="padding:8px">
                        <img src="http://lepkom.gunadarma.ac.id/calas2013/file/image/lepkom_logo.png" alt="Lepkom Gunadarma" style="width:100px">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            ...
                            <li><a href="{{ url('/register') }}">Daftar Asisten</a></li>
                        @else
                            <li class="dropdown">
